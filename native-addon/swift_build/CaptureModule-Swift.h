...
#ifndef CAPTUREMODULE_SWIFT_H
#define CAPTUREMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CaptureModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13CaptureModule21CaptureOutputDelegate") SWIFT_AVAILABILITY(macos,introduced=12.3)
@interface CaptureOutputDelegate : NSObject <AVCaptureAudioDataOutputSampleBufferDelegate, SCStreamDelegate, SCStreamOutput>
...
@class NSCoder;
@class NSString;
SWIFT_CLASS("_TtC13CaptureModule14RecordingError")
@interface RecordingError : NSError
...
SWIFT_CLASS_NAMED("ScreenCaptureManager") SWIFT_AVAILABILITY(macos,introduced=12.3)
@interface CCaptureManager : NSObject
...
SWIFT_AVAILABILITY(macos,introduced=14.0)
@interface CCaptureManager (SWIFT_EXTENSION(CaptureModule)) <SCContentSharingPickerObserver>
- (void)contentSharingPicker:(SCContentSharingPicker * _Nonnull)picker didUpdateWithFilter:(SCContentFilter * _Nonnull)filter forStream:(SCStream * _Nullable)stream;
- (void)contentSharingPicker:(SCContentSharingPicker * _Nonnull)picker didCancelForStream:(SCStream * _Nullable)stream;
- (void)contentSharingPickerStartDidFailWithError:(NSError * _Nonnull)error;
@end

@class NSTableView;
@class NSTableColumn;
SWIFT_CLASS("_TtC13CaptureModule15TableDataSource")
